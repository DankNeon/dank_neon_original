...
hi Identifier      guifg=#FF4FE8 guibg=None guisp=None gui= italic   bold   ctermfg=206 ctermbg=None cterm= italic   bold  
hi Keyword         guifg=#F92672 guibg=None guisp=None gui= italic bold ctermfg=197 ctermbg=None cterm= italic bold
